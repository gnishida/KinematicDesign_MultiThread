...
namespace kinematics {
	...
	public:
		...
		void calculateSolutionThread(int thread_id, const std::vector<glm::dmat3x3>& poses, const std::vector<glm::dvec2>& linkage_region_pts, const BBox& bbox, const std::vector<glm::dvec2>& linkage_avoidance_pts, int num_samples, const Object25D& moving_body, std::vector<Solution>& solutions);
		...
		bool optimizeLinkForThreePoses(const std::vector<glm::dmat3x3>& poses, glm::dvec2& A0, glm::dvec2& A1);
		bool optimizeLinkForTwoPoses(const std::vector<glm::dmat3x3>& poses, glm::dvec2& A0, glm::dvec2& A1);
