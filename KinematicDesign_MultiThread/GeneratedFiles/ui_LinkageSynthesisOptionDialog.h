...
public:
    ...
    void setupUi(QDialog *LinkageSynthesisOptionDialog)
    {
        ...
        LinkageSynthesisOptionDialog->resize(352, 491);
        ...
        pushButtonOK->setGeometry(QRect(60, 450, 91, 31));
        pushButtonCancel = new QPushButton(LinkageSynthesisOptionDialog);
        pushButtonCancel->setObjectName(QStringLiteral("pushButtonCancel"));
        pushButtonCancel->setGeometry(QRect(200, 450, 91, 31));
        ...
        groupBox_2->setGeometry(QRect(20, 200, 311, 131));
        ...
        groupBox_3->setGeometry(QRect(20, 340, 311, 91));
